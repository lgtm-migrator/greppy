...
github_repository = "greppy"
github_url = f"https://github.com/{github_username}/{github_repository}"

rst_prolog = f""".. |pkgname| replace:: greppy
.. |pkgname2| replace:: ``greppy``
.. |browse_github| replace:: `Browse the GitHub Repository <{github_url}>`__
"""

author = "Dominic Davis-Foster"
project = "greppy".replace('_', '-')
...
documentation_summary = "Recursively grep over Python files in the files in the given directory."
